...
INSERT INTO vcard_profiles (
  ...
  logo_scale, cover_position_y, cover_zoom, tags, status
) VALUES (
  ...
  100, 50, 100, '#VIP, #Socio, #MasterBarber, #Mexicali, #IronAndAnchor', 'active'
)
...
INSERT INTO vcard_profiles (
  ...
  100, 50, 100, '#Senior, #Barba, #Fade, #Mexicali, #IronAndAnchor', 'active'
)
ON CONFLICT (slug) DO UPDATE SET
  nombre = EXCLUDED.nombre,
  apellido = EXCLUDED.apellido,
...
INSERT INTO vcard_profiles (
  ...
  100, 50, 100, '#Colorista, #Faciales, #Visagismo, #Mexicali, #IronAndAnchor', 'active'
)
ON CONFLICT (slug) DO UPDATE SET
  nombre = EXCLUDED.nombre,
  apellido = EXCLUDED.apellido,
...
INSERT INTO vcard_profiles (
  ...
  100, 50, 100, '#AfeitadoClasico, #Navaja, #ToallaCaliente, #IronAndAnchor', 'active'
)
ON CONFLICT (slug) DO UPDATE SET
  nombre = EXCLUDED.nombre,
  apellido = EXCLUDED.apellido,
...
INSERT INTO vcard_profiles (
  ...
  100, 50, 100, '#Freestyle, #Tendencias, #FrenchCrop, #Urban, #IronAndAnchor', 'active'
)
ON CONFLICT (slug) DO UPDATE SET
  nombre = EXCLUDED.nombre,
  apellido = EXCLUDED.apellido,
...
INSERT INTO vcard_profiles (
  ...
  100, 50, 100, '#Junior, #AtencionAlCliente, #Mexicali, #IronAndAnchor', 'active'
)
ON CONFLICT (slug) DO UPDATE SET
  nombre = EXCLUDED.nombre,
  apellido = EXCLUDED.apellido,
